...
import com.example.pokemon.fragment.DetailFragment;
import com.example.pokemon.fragment.PokemonList;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setTitle("PokemonApi");
        setSupportActionBar(toolbar);
        LocalBroadcastManager.getInstance(this).registerReceiver(showDetail,new IntentFilter(Comm.ENABLE_KEY_HOME));
    }
